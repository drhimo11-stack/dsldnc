...
object BrowserList {
    ...
    val SUPPORTED_BROWSERS: List<SupportedBrowser> = listOf(
        ...
        // --- Additional browsers requested for blocking ---
        SupportedBrowser("com.ucmobile.lite", null), // UC Mini
        SupportedBrowser("com.cloudmosa.puffinFree", null), // Puffin Browser
        SupportedBrowser("mobi.mgeek.TunnyBrowser", null), // Dolphin Browser
        SupportedBrowser("com.aloha.browser", null), // Aloha Browser
        SupportedBrowser("org.mozilla.focus", null), // Firefox Focus
        SupportedBrowser("com.qwant.liberty", null), // Qwant Browser
        SupportedBrowser("mark.via.gp", null), // Via Browser
        SupportedBrowser("com.transsion.phoenix", null), // Phoenix Browser
        SupportedBrowser("us.spotco.fennec_dos", null), // Mull Browser
        SupportedBrowser("org.cromite.cromite", null), // Cromite
        SupportedBrowser("org.mozilla.fennec_fdroid", null), // Fennec
        SupportedBrowser("acr.browser.lightning", null), // Lightning Browser
        SupportedBrowser("org.torproject.android", null), // Orbot

        // --- Download managers / torrent clients ---
        // Not browsers, but treated the same way as the Snaptube/VidMate
        // entries above: no stable URL bar, so they fall back to the
        // generic node-walking + full visible-text keyword scan.
        SupportedBrowser("idm.internet.download.manager", null), // 1DM
        SupportedBrowser("com.dv.adm", null), // Advanced Download Manager / ADM Pro
        SupportedBrowser("org.freedownloadmanager.fdm", null), // Free Download Manager
        SupportedBrowser("com.junkfood.seal", null), // Seal
        SupportedBrowser("org.schabi.newpipe", null), // NewPipe
        SupportedBrowser("org.schabi.newpipelegacy", null), // NewPipe Legacy
        SupportedBrowser("org.polymorphicshade.newpipe", null), // NewPipe x SponsorBlock
        SupportedBrowser("com.deniscerri.ytdlnis", null), // YTDLnis
        SupportedBrowser("com.videoder.videoder", null), // Videoder
        SupportedBrowser("cn.keepv.id", null), // KeepVid
        SupportedBrowser("com.instube.instube", null), // InsTube
        SupportedBrowser("com.dentex.youtube.downloader", null), // Dentex YouTube Downloader
        SupportedBrowser("com.gianlu.aria2app", null), // Aria2App
        SupportedBrowser("com.delphicoder.flud", null), // Flud
        SupportedBrowser("org.proninyaroslav.libretorrent", null), // LibreTorrent
        SupportedBrowser("com.bittorrent.client", null), // µTorrent
        SupportedBrowser("com.bittorrent.btplus", null), // BitTorrent
        SupportedBrowser("com.frostwire.android", null), // FrostWire

        // --- NewPipe-family / YouTube-alternative front ends ---
        SupportedBrowser("com.github.libretube", null), // LibreTube
        SupportedBrowser("com.bp.clipious", null), // Clipious
        SupportedBrowser("com.futo.platformplayer", null), // Grayjay
        SupportedBrowser("app.revanced.android.youtube", null), // YouTube ReVanced

        // --- Manga / anime readers ---
        SupportedBrowser("eu.kanade.tachiyomi", null), // Tachiyomi
        SupportedBrowser("app.mihon", null), // Mihon
        SupportedBrowser("org.koitharu.kotatsu", null), // Kotatsu

        // --- Streaming / media-center apps ---
        SupportedBrowser("com.lagradost.cloudstream3", null), // CloudStream
        SupportedBrowser("com.stremio.one", null), // Stremio
        SupportedBrowser("org.xbmc.kodi", null), // Kodi
        SupportedBrowser("com.plexapp.android", null), // Plex

        // --- Casting apps ---
        SupportedBrowser("com.koushikdutta.cast", null), // AllCast
        SupportedBrowser("com.instantbits.cast.localcast", null) // LocalCast
    )
