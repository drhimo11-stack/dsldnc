...
class MainActivity : ComponentActivity() {
    ...
    /**
     * "Draw over other apps" — required for the block screen to render as
     * a real system overlay (TYPE_APPLICATION_OVERLAY) instead of a plain
     * Activity. This is what lets it show up on top of Samsung's
     * pop-up/mini-window (multi-window) mode, split-screen, and PIP,
     * where a normal Activity can otherwise end up hidden behind the
     * still-interactive floating app window.
     */
